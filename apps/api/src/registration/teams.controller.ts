...
export class TeamsController {
  ...
  @ApiOperation({
    ...
    description: 'Trả về danh sách tất cả đội bóng. Yêu cầu quyền ADMIN hoặc TEAM_MANAGER.',
  })
  @ApiOkResponse({
  ...
  @ApiForbiddenResponse({ description: 'Không có quyền truy cập (yêu cầu ADMIN hoặc TEAM_MANAGER)' })
